...
export type SearchBestMatchType = "song" | "artist" | "album" | "genre" | "publisher" | "label" | "distributor" | "playlist"
export class SearchBestMatch {

    public type: SearchBestMatchType;
    public match: Song | Artist | Album | Genre | Distributor | Label | Publisher | Playlist;
