...
import { Future, Page, Pageable, isNull, toFuture } from "@repo/utilities";
...
export class SCSDKPlaylistService {
   ...
   */
  public readonly $library: Observable<Playlist[]>;
  ...
  constructor(
    ...
    this.$library = this.librarySubject.asObservable();
   ...
   */
  private addToLocalLibrary(playlist: Playlist | null) {
