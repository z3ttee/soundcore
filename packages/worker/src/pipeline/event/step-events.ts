...
type StepSkippedEventHandler = (reason: string, step: Step, stage: Stage, pipeline: Pipeline) => Promise<void> | void;

export type StepEventNames = "step:started" | "step:completed" | "step:failed" | "step:progress" | "step:message" | "step:skipped"
export type StepEventHandler<T extends StepEventNames> = 
    ...
    T extends "step:message" ? StepMessageEventHandler :     
    T extends "step:skipped" ? StepSkippedEventHandler : never;
