...
type StageSkippedEventHandler = (reason: string, stage: Stage, pipeline: Pipeline) => Promise<void> | void;

export type StageEventNames = "stage:started" | "stage:completed" | "stage:failed" | "stage:progress" | "stage:message" | "stage:skipped"
export type StageEventHandler<T extends StageEventNames> = 
    ...
    T extends "stage:message" ? StageMessageEventHandler : 
