...
export abstract class BaseQueue<T, EN, EC> {

    private readonly _events: Map<EN, EC> = new Map();
    ...
    protected get eventRegistry(): Map<EN, EC> {
        return this._events;
    }
     ...
     */
    public async on<T extends EN>(eventName: T, callback: EC) {
